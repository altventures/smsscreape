...
import 'admin_user_manage_model.dart';
export 'admin_user_manage_model.dart';

class AdminUserManageWidget extends StatefulWidget {
  const AdminUserManageWidget({Key? key}) : super(key: key);

  @override
  _AdminUserManageWidgetState createState() => _AdminUserManageWidgetState();
}

class _AdminUserManageWidgetState extends State<AdminUserManageWidget> {
  late AdminUserManageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminUserManageModel());
